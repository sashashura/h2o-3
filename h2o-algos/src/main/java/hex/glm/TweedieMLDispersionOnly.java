...
public class TweedieMLDispersionOnly {
    ...
    public TweedieMLDispersionOnly(Frame train, GLMModel.GLMParameters parms, GLMModel model, double[] beta,
        ...
        DispersonTask.GenPrediction gPred = new DispersonTask.GenPrediction(beta, model, dinfo).doAll(
        ...
        DispersonTask.ComputeTweedieConstTsk _tweedieConst = new DispersonTask.ComputeTweedieConstTsk(_variancePower, _infoFrame);
