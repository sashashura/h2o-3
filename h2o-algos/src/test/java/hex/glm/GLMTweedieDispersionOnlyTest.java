...
public class GLMTweedieDispersionOnlyTest extends TestUtil {
    ...
    @Test
    public void testTweedieDispersionPExceed2() {
        Scope.enter();
        try {
    ...
    @Test
    public void testTweedieDispersionPExceed2Hard() {
        Scope.enter();
        try {
            // test with variance power > 2
...
/*            double[] dispersionList = new double[]{1.5,
            1.8260182799057185,
            2.0097878313506956,
            2.052742538529438}; // p = 1.8, truePhi = 2 */
/*            double[] dispersionList = new double[]{1.5, 1.8788421971536933, 2.1493997088495664, 2.2472911065194165,
                    2.2568798504373584, 2.256961274905491}; // p=2.5, truePhi = 2.5, init = 1.5*/
            ...
            for (int index=0; index < logll.length; index++) {
                ...
                DispersonTask.ComputeMaxSumSeriesTsk computeTask = new DispersonTask.ComputeMaxSumSeriesTsk(
                        mlDisp, params);
    ...
    public void assertCorrectInfoColWithWeight(Frame train) {
        ...
        TweedieMLDispersionOnly mlDispW = new TweedieMLDispersionOnly(train, params, glmMLW,
                glmMLW.beta(), dinfo);
        DispersonTask.ComputeMaxSumSeriesTsk computeTaskW = new DispersonTask.ComputeMaxSumSeriesTsk(
                mlDispW, params);
