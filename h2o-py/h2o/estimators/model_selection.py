...
class H2OModelSelectionEstimator(H2OEstimator):
    ...
    def __init__(self,
                 ...
                 mode="maxr",  # type: Literal["allsubsets", "maxr", "maxrsweep", "maxrsweepfull", "maxrsweepsmall", "backward"]
        ...
        :param mode: Mode: Used to choose model selection algorithms to use.  Options include 'allsubsets' for all
               ...
               Defaults to ``"maxr"``.
        :type mode: Literal["allsubsets", "maxr", "maxrsweep", "maxrsweepfull", "maxrsweepsmall", "backward"]
    ...
    def mode(self):
        ...
        Type: ``Literal["allsubsets", "maxr", "maxrsweep", "maxrsweepfull", "maxrsweepsmall", "backward"]``, defaults to
        ``"maxr"``.
        """
    ...
    @mode.setter
    def mode(self, mode):
        assert_is_type(mode, None, Enum("allsubsets", "maxr", "maxrsweep", "maxrsweepfull", "maxrsweepsmall", "backward"))
